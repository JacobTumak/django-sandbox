...
SECRET_KEY = 'django-insecure-&)bvu1dlz8rp1t2n(nn(1_n+y(4sj*n6iz$@3+9c_ju_84vtqn'
...
INSTALLED_APPS = [
    ...
    "agreement.apps.SignoffFieldTestConfig",
    "test_stuff.apps.TestStuffConfig",
    "approvals.apps.ApprovalsConfig"
    # "terms_of_service.apps.TermsOfServiceConfig"
]
